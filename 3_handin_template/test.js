...
const Client = require("../3_handin_template/models/client.js");
const Account = require("../3_handin_template/models/account.js");
...
// connecto to db
let connection = mongoose.connect('config.mongodb://localhost/Banking', {
